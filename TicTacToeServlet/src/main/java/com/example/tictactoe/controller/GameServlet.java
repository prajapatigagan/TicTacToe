...
//    private static final char AI_SYMBOL = 'O';   // AI plays O
...
//        }
//
//        // Mode & difficulty from UI
//        String mode = req.getParameter("mode");          // "ai" or "pvp"
//        String diff = req.getParameter("difficulty");    // EASY/MEDIUM/HARD
//
//        if (mode != null) {
...
//
//        // Human move
//        String move = req.getParameter("move"); // "r,c"
...
//        }
//
//        // Check result after human
//        char w = game.checkWinner();
//        if (w == '-') {
//            // AI move if enabled and board not full and AI's turn
...
//                if (aiMv != null) {
//                    game.makeMove(aiMv[0], aiMv[1]);
//                }
//                w = game.checkWinner(); // re-check after AI
//            }
//        }
//
//        // Winner/Tie message
//        if (w != '-') {
//            String p1 = (String) session.getAttribute("player1"); // X
//            String p2 = (String) session.getAttribute("player2"); // O (AI)
//            String winnerName = (w == 'X') ? p1 : (Boolean.TRUE.equals(session.getAttribute(ATTR_AI_ENABLED)) ? "Computer" : p2);
//            req.setAttribute("winner", "🏆 " + winnerName + " wins!");
